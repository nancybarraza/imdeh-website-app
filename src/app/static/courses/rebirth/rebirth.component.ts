...
const LOG_TAG = '[static/courses/rebirth]';
...
export class RebirthComponent implements OnInit, AfterViewInit {
	 ...
	 * @readonly
	 */
	public readonly galleryImages: string[] = ['assets/img/imdeh/renace1.jpeg'];
